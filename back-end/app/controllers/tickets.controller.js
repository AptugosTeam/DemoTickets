...
exports.create = async (options) => {
  ...
  if (typeof data.ID !== 'undefined') updatedData['ID'] = data.ID
  ...
  if (typeof data.Importancia !== 'undefined') updatedData['Importancia'] = data.Importancia

  if (typeof data.Usuario !== 'undefined') updatedData['Usuario'] = data.Usuario
